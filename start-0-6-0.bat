...
cd %bat_path%Word-As-Image-Extended
@echo on
call python code/main_0_5_0.py  --semantic_concept "A cat" --word "中文" --optimized_letter "中文" --font "GoNotoCurrent-Bold" --seed 11
cd %bat_path%

:: Run the sample again. 2.
cd %bat_path%Word-As-Image-Extended
@echo on
call python code/main_0_5_0.py  --semantic_concept "Clouds" --word "中文" --optimized_letter "中文" --font "GoNotoCurrent-Bold" --seed 23
cd %bat_path%

:: Run the sample again. 3.
cd %bat_path%Word-As-Image-Extended
@echo on
call python code/main_0_5_0.py  --semantic_concept "A tree" --word "中文" --optimized_letter "中文" --font "GoNotoCurrent-Bold" --seed 31
cd %bat_path%

:: Run the sample again. 4.
cd %bat_path%Word-As-Image-Extended
@echo on
call python code/main_0_5_0.py  --semantic_concept "An apple" --word "中文" --optimized_letter "中文" --font "GoNotoCurrent-Bold" --seed 41
cd %bat_path%

:: Run the sample again. 5.
cd %bat_path%Word-As-Image-Extended
@echo on
call python code/main_0_5_0.py  --semantic_concept "An olive branch" --word "中文" --optimized_letter "中文" --font "GoNotoCurrent-Bold" --seed 53
cd %bat_path%
